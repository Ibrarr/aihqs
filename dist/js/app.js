...
jQuery(document).ready(function ($) {
    ...
    $.ajax({
      ...
      success: function success(response) {
        ...
        if (data.count > 0) {
          ...
          // No results found for the first call
  ...
  $('#clear-filters').on('click', function () {
    ...
    var selectize = $("#ai-tool-filter #category")[0].selectize;
    if (selectize) {
      selectize.clear();
    }
  ...
  for (i = 0; i < l; i++) {
    ...
    for (j = 1; j < ll; j++) {
      ...
      c.addEventListener("click", function (e) {
        ...
        // Dispatch the change event on the original select element
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkaihqs"] = self["webpackChunkaihqs"] || [];
...
/******/ 	__webpack_require__.O(undefined, ["css/app"], function() { return __webpack_require__("./src/js/dropdown.js"); })
/******/ 	__webpack_require__.O(undefined, ["css/app"], function() { return __webpack_require__("./src/js/app.js"); })
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["css/app"], function() { return __webpack_require__("./src/css/app.scss"); })
